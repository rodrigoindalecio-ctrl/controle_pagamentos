...
const AVAILABLE_TAGS = [
    ...
    { label: 'Nacionalidade', tag: '{{cliente_nacionalidade}}', icon: Tag, group: 'Cliente' },
    { label: 'Estado Civil', tag: '{{cliente_estado_civil}}', icon: Tag, group: 'Cliente' },
    { label: 'Profissão', tag: '{{cliente_profissao}}', icon: Building, group: 'Cliente' },
    { label: 'Nascimento', tag: '{{cliente_nascimento}}', icon: Calendar, group: 'Cliente' },
    { label: 'Endereço', tag: '{{cliente_endereco}}', icon: MapPin, group: 'Cliente' },
    { label: 'Bairro', tag: '{{cliente_bairro}}', icon: MapPin, group: 'Cliente' },
    { label: 'CEP', tag: '{{cliente_cep}}', icon: MapPin, group: 'Cliente' },
    { label: 'Cidade', tag: '{{cliente_cidade}}', icon: Building, group: 'Cliente' },
    { label: 'Estado', tag: '{{cliente_estado}}', icon: Building, group: 'Cliente' },
    { label: 'Telefone', tag: '{{cliente_telefone}}', icon: Tag, group: 'Cliente' },
    { label: 'Parceiro(a)', tag: '{{noivo_nome}}', icon: User, group: 'Evento' },
    { label: 'Data Evento', tag: '{{data_evento}}', icon: Calendar, group: 'Evento' },
    { label: 'Local', tag: '{{local_evento}}', icon: MapPin, group: 'Evento' },
    { label: 'Horário Início', tag: '{{horario_inicio}}', icon: Tag, group: 'Evento' },
    { label: 'Horário Fim', tag: '{{horario_fim}}', icon: Tag, group: 'Evento' },
    { label: 'Convidados', tag: '{{quantidade_convidados}}', icon: Tag, group: 'Evento' },
    { label: 'Valor', tag: '{{valor_contrato}}', icon: CreditCard, group: 'Evento' },
    { label: 'Hora Extra', tag: '{{valor_hora_extra}}', icon: CreditCard, group: 'Evento' },
    { label: 'Prazo Pagto', tag: '{{prazo_pagamento}}', icon: Tag, group: 'Evento' },
    { label: 'Empresa', tag: '{{empresa_nome}}', icon: Building, group: 'Empresa' },
    { label: 'CNPJ', tag: '{{empresa_cnpj}}', icon: CreditCard, group: 'Empresa' },
    { label: 'Endereço Empresa', tag: '{{empresa_endereco}}', icon: MapPin, group: 'Empresa' },
    { label: 'Representante', tag: '{{empresa_representante}}', icon: User, group: 'Empresa' },
    { label: 'RG Repr.', tag: '{{empresa_representante_rg}}', icon: CreditCard, group: 'Empresa' },
    { label: 'CPF Repr.', tag: '{{empresa_representante_cpf}}', icon: CreditCard, group: 'Empresa' },
    { label: 'Tel. Empresa', tag: '{{empresa_telefone}}', icon: Tag, group: 'Empresa' },
    { label: 'Data de Hoje', tag: '{{data_hoje}}', icon: Calendar, group: 'Empresa' },
    { label: 'Cidade (Hoje)', tag: '{{cidade_hoje}}', icon: MapPin, group: 'Empresa' },
];
